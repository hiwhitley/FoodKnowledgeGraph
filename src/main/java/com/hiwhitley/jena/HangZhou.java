...
//        hangZhou.generateIndividuals(ontModel, Constant.re_茶馆, "/home/hiwhitley/文档/rdf/茶馆.json");
//        hangZhou.generateIndividuals(ontModel, Constant.re_西餐, "/home/hiwhitley/文档/rdf/西餐.json");
        hangZhou.generateIndividuals(ontModel, Constant.re_面包点心, "/home/hiwhitley/文档/rdf/面包点心.json");
        hangZhou.generateIndividuals(ontModel, Constant.re_韩国料理, "/home/hiwhitley/文档/rdf/韩国料理.json");

        ontModel.write(System.out);
        hangZhou.writeToFile(ontModel);
        Logger.getLogger("dsfhuid").log(Level.WARNING, "123df1s4f1a6fd456");
    }
